...
var y = class extends e {
  ...
  renderSingleCanvas(t2, e2, i2, n2, s2, r2, o2) {
    ...
    if (e2.renderFunction ? (h2.fillStyle = this.convertColorValues(e2.waveColor), e2.renderFunction(t2, h2)) : this.renderWaveform(t2, e2, h2), l2.width > 0 && l2.height > 0) {
      const t3 = l2.cloneNode(), i3 = t3.getContext("2d");
      i3.drawImage(l2, 0, 0), i3.globalCompositeOperation = "source-in", i3.fillStyle = this.convertColorValues(e2.progressColor), i3.fillRect(0, 0, l2.width, l2.height), o2.appendChild(t3);
    }
  }
